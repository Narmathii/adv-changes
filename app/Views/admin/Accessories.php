...
<body>
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                    <h1 class="page-title fw-semibold fs-18 mb-0">Accessories</h1>
        ...
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myLargeModalLabel">Add Accessories</h5>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="my-2">
                                ...
                                <input type="text" class="form-control access_title" id="access_title"
                                    placeholder="Accessories Tilte" name="access_title" value="">
    ...
    <script src="<?php echo base_url() ?>assets/admin/js/accessories.js"></script>
