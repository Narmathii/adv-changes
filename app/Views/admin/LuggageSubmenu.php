...
<body>
                    ...
                    <form id="submenu-form">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <span class="error text-danger lug_menu mt-5"></span>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="my-2">
                                <label for="lug_submenu" class="form-label">Sub Menu Name</label>
                                <input type="text" class="form-control lug_submenu" id="lug_submenu"
                                    placeholder="Sub Menu Tilte" name="lug_submenu" value="">
                                <span class="error text-danger lug_submenu mt-10"></span>
                            </div>
                        </div>
    ...
    <script src="<?php echo base_url() ?>assets/admin/js/luggageSubmenu.js"></script>
