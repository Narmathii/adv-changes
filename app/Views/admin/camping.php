...
<body>
                    ...
                    <div class="ms-md-1 ms-0">
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item"><a href="#">Camping</a></li>
                ...
                <div class="modal-body">
                    <form id="mainmenu-form">
                        <div class="col-md-12">
                            ...
                            <div class="my-2">
                                <label for="camp_menu" class="form-label">Menu Name</label>
                                <input type="text" class="form-control camp_menu" id="camp_menu" placeholder="Menu"
                                    name="camp_menu" value="">
                                <span class="error text-danger camp_menu mt-10"></span>
                            </div>
    ...
    <script src="<?php echo base_url() ?>assets/admin/js/campMenu.js"></script>
