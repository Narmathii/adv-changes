...
<body>
                    ...
                    <div class="ms-md-1 ms-0">
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item"><a href="#">Helmets And Accessories</a></li>
                ...
                <div class="modal-body">
                    <form id="mainmenu-form">
                        <div class="col-md-12">
                            ...
                            <div class="my-2">
                                <label for="h_menu" class="form-label">Menu Name</label>
                                <input type="text" class="form-control h_menu" id="h_menu"
                                    placeholder="Menu" name="h_menu" value="">
                                <span class="error text-danger h_menu mt-10"></span>
                            </div>
    ...
    <script src="<?php echo base_url() ?>assets/admin/js/helmetMenu.js"></script>
