...
<body>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="submenu-form">
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label for="h_menu_id" class="form-label">Menu
                                </label><br>
                                <select class="form-select" name="h_menu_id" id="h_menu_id">
                                    <option value="">Select Menu</option>
                                    <?php foreach ($menu as $data) {
                                        ?>
                                        <option value="<?php echo $data['h_menu_id'] ?>">
                                            <?php echo $data['h_menu'] ?>
                                        </option>
                                    <?php } ?>
                                </select>
                                <span class="error text-danger h_menu_id mt-5"></span>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="my-2">
                                <label for="h_submenu" class="form-label">Sub Menu</label>
                                <input type="text" class="form-control h_submenu" id="h_submenu" placeholder="Sub Menu"
                                    name="h_submenu" value="">
                                <span class="error text-danger h_submenu	 mt-10"></span>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="file" id="hsubmenu_img" name="hsubmenu_img">

                            <img src="" id="modal_image_url" alt="image" width="130px"
                                style="padding-top: 15px; display:none;">

                            <span class="error text-danger hsubmenu_img mt-5"></span>
                        </div>
    ...
    <script src="<?php echo base_url() ?>assets/admin/js/helmetSubmenu.js"></script>
