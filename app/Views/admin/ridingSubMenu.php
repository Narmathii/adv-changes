...
<body>
                    ...
                    <div class="ms-md-1 ms-0">
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item"><a href="#">Riding Gears</a></li>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="submenu-form">
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label for="r_menu_id" class="form-label">Menu
                                </label><br>
                                <select class="form-select" name="r_menu_id" id="r_menu_id">
                                    <option value="">Select Menu</option>
                                    <?php foreach ($menu as $data) {
                                        ?>
                                        <option value="<?php echo $data['r_menu_id'] ?>">
                                            <?php echo $data['r_menu'] ?>
                                        </option>
                                    <?php } ?>
                                </select>
                        ...
                        <div class="col-md-12">
                            <div class="my-2">
                                <label for="r_sub_menu" class="form-label">Sub Menu Name</label>
                                <input type="text" class="form-control r_sub_menu" id="r_sub_menu"
                                    placeholder="Sub Menu Tilte" name="r_sub_menu" value="">
                                <span class="error text-danger r_sub_menu mt-10"></span>
                            </div>
                        </div>
    ...
    <script src="<?php echo base_url() ?>assets/admin/js/rSubMenu.js"></script>
