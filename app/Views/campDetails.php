...
<style>
    ...
    .stock_status_display>.status_color.status_success {
        color: #85a229 !important;
    }

    .stock_status_display>.status_color.status_failure {
        color: red !important;
    }
...
.field input { padding-left: 45px; }
.popup .field input { padding-left: 45px; }
...
<body onload="initialize()" class="dark-scheme">
    <div id="wrapper">
                    ...
                    <div class="row g-5">
                        <div class="col-lg-1 col-md-2 col-sm-3 col-4 p-0 web-view">
                            <div id="slider-thumbimage-desk">
                                <img class='slideshow-thumbnails active'
                                    src='<?= base_url() ?><?= $prod_details['product_img'] ?>'>
                                <?php
                                $baseurl = base_url();
                                for ($i = 0; $i <= 10; $i++) {
                                    $img = trim($prod_details["img_" . $i]);
                        ...
                        <div class="col-lg-4 web-view">
                            ...
                            <div id='slideshow-items-container'>
                                ...
                                <?php
                                for ($i = 0; $i <= 10; $i++) {
                                    if ($prod_details["img_" . $i] != "") { ?>
                                        <img class='slideshow-items' src='<?= base_url() ?><?= $prod_details["img_" . $i] ?>'>
                                    <?php }
                                } ?>
                                <form>
                                    <?php
                                    $offerType = $prod_details['offer_type'];
                                    $offerDetail = $prod_details['offer_details'];
                                    ...
                                    <?php } else { ?>
                                        <span class=" discount-tag"><?php echo $prod_details['offer_details'] ?>%<span
                                                class="off_span">off</span></span>
                                    <?php }
                                    ?>

                                    <input type="hidden" name="prod_id" id="prod_id"
                                        value="<?php echo $prod_details['prod_id'] ?>" />
                        ...
                        <div class="col-lg-6 mob-view">
                            <form>
                                    ...
                                    for ($i = 0; $i <= 10; $i++) {
                                        if ($prod_details["img_" . $i] != "") { ?>
                                            <img class='slideshow-items-mob'
                                                src='<?= base_url() ?><?= $prod_details["img_" . $i] ?>'>
                                        <?php }
                                    } ?>
                                </div>
                                ...
                                <?php } else { ?>
                                    <span class="offerrate offer"><?php echo $prod_details['offer_details'] ?>%</span>
                                <?php }
                                ?>
                        ...
                        <div class="col-lg-7 pb-0 product_details">
                            <div class="de-price pb-2">
                                <span class="vehicle_name"><?php echo $prod_details['product_name'] ?></span>
                            </div>
                            <div class="col-lg-12 block-with-text p-0">
                                <!-- <label class="pb-2"><strong>Description : </strong></label> -->
                                <span><?php echo $prod_details['prod_desc'] ?></span>
                            </div>
                                ...
                                <form name="contactForm" id='product-form' method="post">
                                    ...
                                    <div class='row'>
                                        ...
                                        <input type="hidden" name="config_image1" id="config_image"
                                            value="<?= $prod_details['product_img'] ?>" />
                                        <!-- <input type="hidden" name="color" id="color_val"
                                            value="<?php echo $prod_details['color'][0] ?>" /> -->
                                        <input type="hidden" name="size" id="initial_size_stock"
                                            value="<?php echo $prod_details['stock'][0] ?>" />
                                    ...
                                    <div class="popup">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="field">
                                                <input type="text" id="copy-text" value="<?= $current_url ?>" style="margin-left: 4px;">
                                ...
                                <div class="col-lg-12 p-0">
                                    <p class="offer_price">
                                        ...
                                        if ($offerType == 0 || $offerType == 1) { ?>
                                            <span
                                                class="m-0 price_span">INR.<?= preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $prod_details['offer_price']) ?></span><span
                                                class="real_price strike">
                                                INR.<?= preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $prod_details['product_price']); ?></span>
                                            <?php
                                        } else { ?>
                                            <span
                                                class="m-0 price_span">INR.<?= preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $prod_details['offer_price']) ?></span></span>
                            ...
                            <div class="d-flex wish-status">
                                <p class="d-flex align-items-center  stock_status_display ">
                                    <span class="stock_status"> </span><span class="status_color"></span>
                            </div>
                            <input type="hidden" name="table_name" id="table_name" value="<?php echo $tbl_name ?>" />
                            <input type="hidden" name="prod_id" id="prod_id"
                                value="<?php echo $prod_details['prod_id'] ?>" />
                            <input type="hidden" name="prod_price" id="prod_price"
                                value="<?php echo $prod_details['offer_price'] ?>" />

                            <input type="hidden" name="size_stock" id="size_stock" value="">

                            <!-- Stock based on Size -->
                            <?php
                            $ConfigSize = $prod_details['size'];
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <p class="mb-0" style="color:#000">Quantity </p>
                            ...
                            <!-- For Quantity Update -->
                            <input type="hidden" class="main-stock" value="<?= $prod_details['quantity'] ?>"
                                data-sizeval="<?= $countSize ?>">

                            <!-- Stock & DropShipping start -->
                            <div class="d-flex wish-status">
                                <?php
                                if ($prod_details['quantity'] <= 0) {
                                ...
                                <p class="d-flex align-items-center drop-status <?php echo $className ?>">
                                    <span>Stock status: </span>
                                    &nbsp;<strong class="stock-text"><?php echo $quantity ?></strong>
                                </p>
                            </div>

                            <?php if ($prod_details['drop_shipping'] != 0) { ?>
                                ...
                                <div class="col-lg-12 btn-detail p-0 ">
                                    ...
                                    <div class="col-lg-8 contactus">
                                        <a class="btn-main btn-fullwidth" type='button'
                                            href="https://wa.me/7358992528?text=<?php echo urlencode("Product Information!\nProduct Name: " . $prod_details['product_name'] . "\nProduct Price: " . $prod_details['product_price']); ?>">
        ...
        <!-- section begin -->
        <section aria-label="section" id=" py-0 details_section" class="px-5 py-0">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                            ...
                            if ($prod_details['prod_desc'] != "") { ?>
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade show active nav-desc" id="nav-home" role="tabpanel"
                                        ...
                                        <p class="m-0 prod-description"><?php echo $prod_details['prod_desc'] ?></p>
                                    </div>

                                </div>
                            <?php } ?>
                        </div>
                        <?php if (!empty($prod_details['specifications'])): ?>
                            ...
                            <div class="tab-default mt-3">
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                                        aria-labelledby="nav-home-tab">
                                        <p class="m-0 prod-specification"><?php echo $prod_details['specifications'] ?></p>
                                    </div>
        ...
        <?php } ?>
        <section id="section-newArrival" class="py-0 px-5">
            <?php
                            ...
                            <?php for ($i = 0; $i < count($similarProducts); $i++) {
                                ...
                                if (!in_array($similarProducts[$i]['prod_id'], $renderedProductIDs)) {
                                    ...
                                    <div class="item">
                                        <div class="">
                                            <a
                                                href="<?php echo base_url() ?>camp-details/<?php echo strtolower(str_replace(' ', '-', $similarProducts[$i]['redirect_url'])) ?>/<?php echo base64_encode($similarProducts[$i]['prod_id']) ?>">
                                                <div class="de-item">
                                                    <?php
                                                    ...
                                                    <div class="d-info">
                                                        <div class="d-text">
                                                            ...
                                                            <?php } else { ?>
                                                                ...
                                                                <div>
                                                                    <a class="btn-main buynow_btn"
                                                                        href="<?php echo base_url() ?>camp-details/<?php echo strtolower(str_replace(' ', '-', $similarProducts[$i]['redirect_url'])) ?>/<?php echo base64_encode($similarProducts[$i]['prod_id']) ?>">Buy
                                                                        Now</a>
                                                                </div>
                                                            <?php } ?>
    ...
    <script>
        $(document).ready(function () {
            let main_stock = parseInt($(".main-stock").val()) || 0;
            let initial_size_stock = $("#initial_size_stock").val();
            let sizecount = $(".main-stock").data('sizeval');


            stockStatus(main_stock, initial_size_stock, sizecount);
            purchaseProduct(main_stock, initial_size_stock, sizecount);
            ...
            function updateQuantity(stock) {
                ...
                stockStatus(main_stock, stock, sizecount);
                purchaseProduct(main_stock, stock, sizecount);
            }

            // initial loading product order

            function purchaseProduct(main_stock, initial_size_stock, sizecount) {

                if ((sizecount === 0 && main_stock <= 0) || (initial_size_stock === 0 && main_stock > 0) || (sizecount > 0 && initial_size_stock === 0)) {
                    $(".product-order").hide();
                    $(".contactus").show();
                    $(".drop-status").removeClass("availableqty").addClass("outofstockqty");
                    $(".stock-text").text("Out of Stock");
                } else if (sizecount === 0 && main_stock >= 0) {
                    $(".product-order").show();
                    $(".contactus").hide();
                    $(".drop-status").removeClass("outofstockqty").addClass("availableqty");
                    $(".stock-text").text("Available");
                }
                else if (initial_size_stock == '' && main_stock >= 0) {
                    $(".product-order").show();
                    $(".contactus").hide();
                    $(".drop-status").removeClass("outofstockqty").addClass("availableqty");
                    $(".stock-text").text("Available");
            ...
            // initial stock status update
            function stockStatus(main_stock, initial_size_stock, sizecount) {
                let stockDisplay = $(".stock_status_display");
                let stockText = $(".stock_status");

                if (main_stock <= 0) {
                    stockDisplay.removeClass("availableqty").addClass("outofstockqty");
                    stockText.text("Stock status:");
                    $(".status_color").removeClass('status_success');
                    $(".status_color").text("Out of Stock").addClass('status_failure')
                } else if (size_stock == 0 && main_stock > 0) {
                    stockDisplay.removeClass("availableqty").addClass("outofstockqty");
                    stockText.text("Stock status:");
                    $(".status_color").removeClass('status_success');
                    $(".status_color").text("This size is currently unavailable.").addClass('status_failure')

                } else if (sizecount === 0 && main_stock > 0) {
                    stockDisplay.removeClass("outofstockqty").addClass("availableqty");
                    stockText.text("Stock status:");
                    $(".status_color").removeClass('status_failure');
                    $(".status_color").text("Available").addClass('status_success')
