                    ...
                    <div class="row g-5">
                        <div class="col-lg-1 col-md-2 col-sm-3 col-4 p-0 web-view">
                            <div id="slider-thumbimage-desk">
                                <img class='slideshow-thumbnails active'
                                    src='<?= base_url() ?><?= $h_details['product_img'] ?>'>
                                <?php
                                $baseurl = base_url();
                                for ($i = 0; $i <= 10; $i++) {
                                    $img = trim($h_details["img_" . $i]);
                        ...
                        <div class="col-lg-4 web-view">
                            ...
                            <div id='slideshow-items-container'>
                                ...
                                for ($i = 0; $i <= 10; $i++) {
                                    if ($h_details["img_" . $i] != "") { ?>
                                        <img class='slideshow-items' src='<?= base_url() ?><?= $h_details["img_" . $i] ?>'>
                                    <?php }
                                } ?>
                                <form>
                                    <?php
                                    $offerType = $h_details['offer_type'];
                                    $offerDetail = $h_details['offer_details'];
                                    ...
                                    <?php } else { ?>
                                        <span class="offerrate offer"><?php echo $h_details['offer_details'] ?>%</span>
                                    <?php }
                                    ?>


                                    <input type="hidden" name="prod_id" id="prod_id"
                                        value="<?php echo $h_details['prod_id'] ?>" />
                        ...
                        <div class="col-lg-7 pb-0 product_details">
                            <div class="de-price">
                                <span class="vehicle_name"><?php echo $h_details['product_name'] ?></span>
                            </div>
                            <div class="col-lg-12 block-with-text pt-2 p-0">
                                <p class="mb-0 "><?php echo $h_details['prod_desc'] ?></p>
                            </div>
                                    ...
                                    <div class="col-lg-12 block-with-text p-0">
                                        <p class="offer_price">
                                            ...
                                            if ($offerType == 0 || $offerType == 1) { ?>
                                                <span
                                                    class="m-0 price_span">INR.<?= preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $h_details['offer_price']) ?></span><span
                                                    class="real_price strike">
                                                    INR.<?= preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $h_details['product_price']); ?></span>
                                                <?php
                                            } else { ?>
                                                <span
                                                    class="m-0 price_span">INR.<?= preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $h_details['offer_price']) ?></span></span>
                            ...
                            <input type="hidden" name="prod_price" id="prod_price"
                                value="<?php echo $h_details['offer_price'] ?>" />

                            <input type="hidden" name="size_stock" id="size_stock" value="">

                            <!-- Stock based on Size -->
                            <?php
                            $ConfigSize = $h_details['size'];
                            ...
                            <?php if ($h_details['drop_shipping'] != 0) { ?>
                            ...
                            <!-- For Quantity Update -->
                            <input type="hidden" class="main-stock" value="<?= $h_details['quantity'] ?>"
                                ...
                                <div class="col-lg-12 btn-detail p-0 ">
                                    ...
                                    <div class="col-lg-8 contactus">
                                        <a class="btn-main btn-fullwidth" type='button'
                                            href="https://wa.me/7358992528?text=<?php echo urlencode("Product Information!\nProduct Name: " . $h_details['product_name'] . "\nProduct Price: " . $h_details['product_price']); ?>">
                            ...
                            if ($h_details['prod_desc'] != "") { ?>
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade show active nav-desc" id="nav-home" role="tabpanel"
                                        ...
                                        <p class="m-0 prod-description"><?php echo $h_details['prod_desc'] ?></p>
                                    </div>

                                </div>
                            <?php } ?>
                        </div>
                        <?php if (!empty($h_details['specifications'])): ?>
                            <div class="tab-default mt-3">
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                                        aria-labelledby="nav-home-tab">
                                        <p class="m-0 prod-specification"><?php echo $h_details['specifications'] ?></p>
                                    </div>
                            ...
                            <?php for ($i = 0; $i < count($similarProducts); $i++) {
                                ...
                                if (!in_array($similarProducts[$i]['prod_id'], $renderedProductIDs)) {
                                    ...
                                    <div class="item">
                                        <div class="">
                                            <a
                                                href="<?php echo base_url() ?>helmet-details/<?php echo strtolower(str_replace(' ', '-', $similarProducts[$i]['redirect_url'])) ?>/<?php echo base64_encode($similarProducts[$i]['prod_id']) ?>">
                                                <div class="de-item">
                                                    <?php
                                                    ...
                                                    <div class="d-info">
                                                        <div class="d-text">
                                                            ...
                                                            <?php } else { ?>
                                                                ...
                                                                <div>
                                                                    <a class="btn-main buynow_btn"
                                                                        href="<?php echo base_url() ?>helmet-details/<?php echo strtolower(str_replace(' ', '-', $similarProducts[$i]['redirect_url'])) ?>/<?php echo base64_encode($similarProducts[$i]['prod_id']) ?>">Buy
                                                                        Now</a>
                                                                </div>
                                                            <?php } ?>
                                                    ...
                                                    <div class="d-text">
                                                        ...
                                                        <?php } else { ?>
                                                            ...
                                                            <div>
                                                                ...
                                                                } else if ($tbl_name == "tbl_rpro duct_list") {
