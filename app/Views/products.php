...
<body id="products_page" class="dark-scheme">
    ...
    <div class="no-bottom no-top zebra">
        ...
        <!-- section close -->
        <section id="section-cars" class="products_wrapper px-5">
            <div class="container access_list_grid">
                <div class="row">
                    <h2 class="mb-4 text-center">
                        <?php echo strtoupper($segment_modal) ?>
                    </h2>
                    <!-- mobile view filter -->
                    ...
                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight"
                        ...
                        <div class="offcanvas-body">
                            ...
                            <input type="hidden" class="common_selector submenuid"
                                value="<?php echo $product[$i]->sub_access_id; ?>" />
                        </div>
                    </div>
                    ...
                    <div class="col-lg-9">
                        ...
                        <input type="hidden" id="brand_id" data-brandid="<?= $brand_id ?>">
        ...
        <script>
            $(document).ready(function () {
                ...
                function filter_data(page = 1) {
                    ...
                    const discount = $('.discount').val();
                    const discount_mob = $('.discount_mob').val();
                    const tablename = 'tbl_accessories_list';
                    const action = 'fetch_data';
                    const modal_id = $("#sub_id").data('subid');
                    const brand_id = $("#brand_id").data('brandid');


                    $.ajax({
                        url: `${base_Url}bike-prod-filter/${page}`,
                        type: "POST",
                        dataType: "json",
                        data: {
                            minimum_price,
