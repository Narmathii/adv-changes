        ...
        <section id="section-cars" class="products_wrapper px-3">
            <div class="container access_list_grid">
                <div class="row">
                    ...
                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight"
                        ...
                        <div class="offcanvas-body">
                            ...
                            <input type="hidden" class="common_selector submenuid"
                                value="<?php echo $r_accessories[0]['r_sub_id'] ?>" />
                        </div>
                    </div>
                    ...
                    <div class="col-lg-9 ">
                        <div class="row seach_results clearfix">
                            <!-- Dynamic Datas -->
        ...
        <script>
            $(document).ready(function () {
                ...
                function filter_data(page = 1) {
                    ...
                    const discount = $('.discount').val();
                    const discount_mob = $('.discount_mob').val();
                    const tablename = 'tbl_rproduct_list';
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            <div class="container">
                                ...
                                <div>
                                    <a class="btn-main buynow_btn"
                                        href="${base_Url}riding-details/${redirectUrl}/${prodId}">
                                        Buy Now
                                    </a>
                                </div>`;
                                    ...
                                    <form>
                                        <div class="de-item">
                                           <span class="discount-tag ${offerClass}">${offerDisp}</span>
                                            ...
                                            <div class="d-img">
                                                <a href="${base_Url}riding-details/${redirectUrl}/${prodId}">
