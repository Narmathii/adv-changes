...
<body onload="initialize()" class="dark-scheme">
    <div id="wrapper">
                    ...
                    <div class="row g-5">
                        <div class="col-lg-1 col-md-2 col-sm-3 col-4 p-0 web-view">
                            <div id="slider-thumbimage-desk">
                                <img class='slideshow-thumbnails active'
                                    src='<?= base_url() ?><?= $r_details['product_img'] ?>'>
                                <?php
                                $baseurl = base_url();
                                for ($i = 0; $i <= 10; $i++) {
                                    $img = trim($r_details["img_" . $i]);
                        ...
                        <div class="col-lg-4 web-view">
                            ...
                            <div id='slideshow-items-container'>
                                ...
                                for ($i = 0; $i <= 10; $i++) {
                                    if ($r_details["img_" . $i] != "") { ?>
                                        <img class='slideshow-items' src='<?= base_url() ?><?= $r_details["img_" . $i] ?>'>
                                    <?php }
                                } ?>
                                <form>
                                    <?php
                                    $offerType = $r_details['offer_type'];
                                    $offerDetail = $r_details['offer_details'];
                                    ...
                                    <?php } else { ?>
                                        <span class="offerrate offer"><?php echo $r_details['offer_details'] ?>%</span>
                                    <?php }
                                    ?>
                        ...
                        <div class="col-lg-7 pb-0 product_details">
                            <div class="de-price">
                                <span class="vehicle_name"><?php echo $r_details['product_name'] ?></span>
                            </div>
                            <div class="col-lg-12 block-with-text p-0">
                                <span><?php echo $r_details['prod_desc'] ?></span>
                            </div>
                                ...
                                <form name="contactForm" id='product-form' method="post">
                                    ...
                                    <div class='row'>
                                        ...
                                        <input type="hidden" name="config_image1" id="config_image"
                                            value="<?= $r_details['product_img'] ?>" />
                                        <!-- <input type="hidden" name="color" id="color_val"
                                            value="<?php echo $r_details['color'][0] ?>" /> -->
                                        <input type="hidden" name="size" id="initial_size_stock"
                                            value="<?php echo $r_details['stock'][0] ?>" />
                                ...
                                <div class="col-lg-12 p-0">
                                    <p class="offer_price">
                                        ...
                                        if ($offerType == 0 || $offerType == 1) { ?>
                                            <span
                                                class="m-0 price_span">INR.<?= preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $r_details['offer_price']) ?></span><span
                                                class="real_price strike">
                                                INR.<?= preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $r_details['product_price']); ?></span>
                                            <?php
                                        } else { ?>
                                            <span
                                                class="m-0 price_span">INR.<?= preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $r_details['offer_price']) ?></span></span>
                            ...
                            <?php if ($r_details['drop_shipping'] != 0) { ?>
                            ...
                            <!-- For Quantity Update -->
                            <input type="hidden" class="main-stock" value="<?= $r_details['quantity'] ?>"
                                data-sizeval="<?= $countSize ?>">
                            <?php
                            $totalSize = $r_details['size'] ? count($r_details['size']) : 0; ?>
                            <input type="hidden" class="size_stock" value="<?= $totalSize ?>" />
                                ...
                                <div class="col-lg-12 btn-detail p-0 ">
                                    ...
                                    <div class="col-lg-8 contactus">
                                        <a class="btn-main btn-fullwidth" type='button'
                                            href="https://wa.me/7358992528?text=<?php echo urlencode("Product Information!\nProduct Name: " . $r_details['product_name'] . "\nProduct Price: " . $r_details['product_price']); ?>">
        ...
        <!-- section begin -->
        <section aria-label="section" id=" py-0 details_section" class="py-0 px-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                            ...
                            if ($r_details['prod_desc'] != "") { ?>
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade show active nav-desc" id="nav-home" role="tabpanel"
                                        ...
                                        <p class="m-0 prod-description"><?php echo $r_details['prod_desc'] ?></p>
                                    </div>

                                </div>
                            <?php } ?>
                        </div>
                        <?php if (!empty($r_details['specifications'])): ?>
                            <div class="tab-default mt-3">
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                                        aria-labelledby="nav-home-tab">
                                        <p class="m-0 prod-specification"><?php echo $r_details['specifications'] ?></p>
                                    </div>
        ...
        <?php
        $className = empty($similarProducts) ? 'd-none' : '';
        ?>
                            ...
                            <?php for ($i = 0; $i < count($similarProducts); $i++) {
                                ...
                                if (!in_array($similarProducts[$i]['prod_id'], $renderedProductIDs)) {
                                    ...
                                    <div class="item">
                                        <div class="">
                                            <a
                                                href="<?php echo base_url() ?>riding-details/<?php echo strtolower(str_replace(' ', '-', $similarProducts[$i]['redirect_url'])) ?>/<?php echo base64_encode($similarProducts[$i]['prod_id']) ?>">
                                                <div class="de-item">
                                                    <div class="d-img">
                                                        <?php
                                                    ...
                                                    <div class="d-info">
                                                        <div class="d-text">
                                                            ...
                                                            <?php } else { ?>
                                                                ...
                                                                <div>
                                                                    <a class="btn-main buynow_btn"
                                                                        href="<?php echo base_url() ?>riding-details/<?php echo strtolower(str_replace(' ', '-', $similarProducts[$i]['redirect_url'])) ?>/<?php echo base64_encode($similarProducts[$i]['prod_id']) ?>">Buy
                                                                        Now</a>
                                                                </div>
                                                            <?php } ?>
                                            ...
                                            <div class="de-item">
                                                <div class="d-img">
                                                    ...
                                                    <img src="<?php echo base_url() ?><?php echo $recent_products[$i]['product_img'] ?>"
                                                        class="img-fluid"
                                                        alt="<?php echo $recent_products[$i]['product_img'] ?>">
                                                </div>
                                                <div class="d-info">
                                                    <div class="d-text">
    ...
    <script>
        $(document).ready(function () {
            ...
            function updateQuantity(stock) {
                console.log("Slected Stock", stock);
                $("#quantity").val(1);
