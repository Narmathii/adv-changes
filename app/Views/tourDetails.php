...
<body onload="initialize()" class="dark-scheme">
    <div id="wrapper">
        ...
        <div class="no-bottom no-top zebra">
            <div id="top"></div>
            <section id="section-product-details" class="pb-0 px-5">
                <div class="container">
                    <div class="row g-5">
                        <div class="col-lg-1 col-md-2 col-sm-3 col-4 p-0 web-view">
                            <div id="slider-thumbimage-desk">
                                <img class='slideshow-thumbnails active'
                                    src='<?= base_url() ?><?= $tour_detail['product_img'] ?>'>
                                <?php
                                $baseurl = base_url();
                                for ($i = 0; $i <= 10; $i++) {
                                    $img = trim($tour_detail["img_" . $i]);
                        ...
                        <div class="col-lg-4 web-view">
                            ...
                            <div id='slideshow-items-container'>
                                ...
                                <?php
                                for ($i = 0; $i <= 10; $i++) {
                                    if ($tour_detail["img_" . $i] != "") { ?>
                                        <img class='slideshow-items' src='<?= base_url() ?><?= $tour_detail["img_" . $i] ?>'>
                                    <?php }
                                } ?>
                                <form>
                                    <?php
                                    $offerType = $tour_detail['offer_type'];
                                    $offerDetail = $tour_detail['offer_details'];
                                    ...
                                    <?php } else { ?>
                                        <span class="offerrate offer"><?php echo $tour_detail['offer_details'] ?>%</span>
                                    <?php }
                                    ?>

                                    <input type="hidden" name="prod_id" id="prod_id"
                                        value="<?php echo $tour_detail['prod_id'] ?>" />
                                    ...
                                    for ($i = 0; $i <= 10; $i++) {
                                        if ($tour_detail["img_" . $i] != "") { ?>
                                            <img class='slideshow-items-mob'
                                                src='<?= base_url() ?><?= $tour_detail["img_" . $i] ?>'>
                                        <?php }
                                    } ?>
                                </div>
                        ...
                        <div class="col-lg-7 pb-0 product_details">
                            <div class="de-price pb-3">
                                <span class="vehicle_name"><?php echo $tour_detail['product_name'] ?></span>
                            </div>
                            <div class="col-lg-12 block-with-text p-0">
                                <span><?php echo $tour_detail['prod_desc'] ?></span>
                            </div>
                                ...
                                <form name="contactForm" id='product-form' method="post">
                                    ...
                                    <div class='row'>
                                        ...
                                        <input type="hidden" name="size" id="initial_size_stock"
                                            value="<?php echo $tour_detail['stock'][0] ?>" />
                                ...
                                <div class="col-lg-12 p-0">
                                    <p class="offer_price">
                                        ...
                                        if ($offerType == 0 || $offerType == 1) { ?>
                                            <span
                                                class="m-0 price_span">INR.<?= preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $tour_detail['offer_price']) ?></span><span
                                                class="real_price strike">
                                                INR.<?= preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $tour_detail['product_price']); ?></span>
                                            <?php
                                        } else { ?>
                                            <span
                                                class="m-0 price_span">INR.<?= preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $tour_detail['offer_price']) ?></span></span>
                            ...
                            <?php if ($tour_detail['drop_shipping'] != 0) { ?>
                            ...
                            <!-- For Quantity Update -->
                            <input type="hidden" class="main-stock" value="<?= $tour_detail['quantity'] ?>"
                                ...
                                <div class="col-lg-12 btn-detail p-0 ">
                                    ...
                                    <div class="col-lg-8 contactus">
                                        <a class="btn-main btn-fullwidth" type='button'
                                            href="https://wa.me/7358992528?text=<?php echo urlencode("Product Information!\nProduct Name: " . $tour_detail['product_name'] . "\nProduct Price: " . $tour_detail['product_price']); ?>">
                            ...
                            if ($tour_detail['prod_desc'] != "") { ?>
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade show active nav-desc" id="nav-home" role="tabpanel"
                                        ...
                                        <p class="m-0 prod-description"><?php echo $tour_detail['prod_desc'] ?></p>
                                    </div>
                        ...
                        <div class="tab-default mt-3">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                                    aria-labelledby="nav-home-tab">
                                    <p class="m-0 prod-specification"><?php echo $tour_detail['specifications'] ?></p>
                                </div>
                            ...
                            <?php for ($i = 0; $i < count($similarProducts); $i++) {
                                ...
                                if (!in_array($similarProducts[$i]['prod_id'], $renderedProductIDs)) {
                                    ...
                                    <div class="item">
                                        <div class="">
                                            <a
                                                href="<?php echo base_url() ?>tour-detail/<?php echo strtolower(str_replace(' ', '-', $similarProducts[$i]['redirect_url'])) ?>/<?php echo base64_encode($similarProducts[$i]['prod_id']) ?>">
                                                <div class="de-item">
                                                    <?php
                                                    ...
                                                    <div class="d-info">
                                                        <div class="d-text">
                                                            ...
                                                            <?php } else { ?>
                                                                ...
                                                                <div>
                                                                    <a class="btn-main buynow_btn"
                                                                        href="<?php echo base_url() ?>tour-detail/<?php echo strtolower(str_replace(' ', '-', $similarProducts[$i]['redirect_url'])) ?>/<?php echo base64_encode($similarProducts[$i]['prod_id']) ?>">Buy
                                                                        Now</a>
                                                                </div>
                                                            <?php } ?>
