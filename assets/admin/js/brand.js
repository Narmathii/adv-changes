$(document).ready(function () {
  ...
  $(document).on("click", ".btnEdit", function () {
    ...
    console.log(res_DATA[index].offer_percentage);
    $("#brand_name").val(res_DATA[index].brand_name);
    $("#offer_percentage").val(res_DATA[index].offer_percentage);
